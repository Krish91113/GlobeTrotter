...
const travelPaces = [
  {
    value: "slow",
    label: "Relaxed & Slow",
    desc: "1-2 activities per day with plenty of free time.",
  },
  {
    value: "moderate",
    label: "Balanced",
    desc: "2-4 activities per day with time to explore.",
  },
  {
    value: "fast",
    label: "Fast-Paced",
    desc: "Packed schedule to see as much as possible.",
  },
];
...
const budgetStyles = [
  {
    ...
    desc: "Hostels, public transit, and free sights.",
  },
  {
    value: "moderate",
    label: "Comfortable",
    desc: "Mid-range hotels, casual dining, and guided tours.",
  },
  {
    value: "luxury",
    label: "Luxury",
    desc: "Premium stays, fine dining, and private experiences.",
  },
];
      ...
      <div className="mt-10 space-y-12">
        ...
        <section className="rounded-2xl border border-[#E2E8F0]/80 bg-white p-6 sm:p-8 shadow-sm">
          ...
          <p className="mt-1 text-sm text-[#64748B]">
            These weights calibrate our smart activity recommendations for your
            trips.
          </p>
          ...
          <div className="mt-8 space-y-6">
            {[
              {
                key: "culture",
                label: "Art, History & Culture",
                desc: "Museums, landmarks, historic walks",
              },
              {
                key: "food",
                label: "Gastronomy & Culinary",
                desc: "Local dining, street food, cooking classes",
              },
              {
                key: "adventure",
                label: "Outdoor & Adventure",
                desc: "Hikes, boat trips, extreme sports",
              },
              {
                key: "nature",
                label: "Parks & Scenic Nature",
                desc: "Gardens, viewpoints, beaches",
              },
              {
                key: "relaxation",
                label: "Relaxation & Leisure",
                desc: "Cafes, spas, slow strolls",
              },
            ].map((interest) => {
              const val = preferences[
                interest.key as keyof typeof preferences
              ] as number;
              return (
                ...
                {budgetStyles.map((style) => (
                  <button
                    ...
                    onClick={() =>
                      setPreferences({
                        ...preferences,
                        budgetLevel: style.value as any,
                      })
                    }
                    className={`rounded-2xl border p-4 text-left transition-all ${
