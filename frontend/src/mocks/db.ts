...
const locations: Location[] = [
  {
    ...
    country: "Italy",
    region: "Europe",
    description: "Ancient wonders & long dinners in the Eternal City.",
    image: IMAGES.rome,
    rating: 4.8,
    averageDailyCost: 120,
    currency: "EUR",
    travelStyles: ["culture", "food", "history"],
  },
  {
    id: "loc-florence",
    name: "Florence",
    country: "Italy",
    region: "Europe",
    description: "Renaissance art, rooftop views and Tuscan cuisine.",
    image: IMAGES.florence,
    rating: 4.7,
    averageDailyCost: 110,
    currency: "EUR",
    travelStyles: ["culture", "food", "art"],
  },
  {
    id: "loc-venice",
    name: "Venice",
    country: "Italy",
    region: "Europe",
    description: "Canals, gondolas and hidden squares.",
    image: IMAGES.venice,
    rating: 4.6,
    averageDailyCost: 140,
    currency: "EUR",
    travelStyles: ["romantic", "culture"],
  },
  {
    id: "loc-kyoto",
    name: "Kyoto",
    country: "Japan",
    region: "Asia",
    description: "Temples, gardens and quiet bamboo lanes.",
    image: IMAGES.kyoto,
    rating: 4.9,
    averageDailyCost: 100,
    currency: "JPY",
    travelStyles: ["culture", "nature", "relaxation"],
  },
  {
    id: "loc-lisbon",
    name: "Lisbon",
    country: "Portugal",
    region: "Europe",
    description: "Tiles, trams, tascas and sunsets over the Tagus.",
    image: IMAGES.lisbon,
    rating: 4.6,
    averageDailyCost: 85,
    currency: "EUR",
  ...
  },
  {
    ...
    country: "Spain",
    region: "Europe",
    description: "Gaudí, beaches, tapas and late nights.",
    image: IMAGES.barcelona,
    rating: 4.7,
    averageDailyCost: 105,
    currency: "EUR",
    travelStyles: ["food", "adventure", "culture"],
  },
  {
    id: "loc-santorini",
    name: "Santorini",
    country: "Greece",
    region: "Europe",
    description: "Caldera views, sunsets and blue-domed churches.",
    image: IMAGES.santorini,
    rating: 4.8,
    averageDailyCost: 150,
    currency: "EUR",
    travelStyles: ["romantic", "relaxation", "luxury"],
  },
  {
    id: "loc-bali",
    name: "Bali",
    ...
    averageDailyCost: 50,
    currency: "USD",
    travelStyles: ["nature", "adventure", "budget"],
  },
];
...
const activities: Activity[] = [
  {
    ...
    description: "Explore the iconic amphitheatre with an expert guide.",
    image: IMAGES.rome,
    rating: 4.8,
    reviewCount: 54120,
    estimatedCost: 50,
  ...
  },
  {
    ...
    category: "Attractions",
    description:
      "Discover Michelangelo's Sistine Chapel and priceless art collections.",
  ...
  },
  {
    ...
    category: "Food",
    description:
      "Enjoy authentic Roman cuisine in the charming Trastevere neighbourhood.",
    image: IMAGES.trastevere,
    rating: 4.6,
    reviewCount: 8120,
    estimatedCost: 30,
    currency: "EUR",
  ...
  },
  {
    ...
    description: "Learn to make fresh pasta and tiramisu with a local chef.",
  ...
  },
  {
    ...
    category: "Food",
    description:
      "Guided food tour through Trastevere's best-kept culinary secrets.",
    image: IMAGES.trastevere,
    rating: 4.7,
    reviewCount: 3390,
    estimatedCost: 45,
  ...
  },
  {
    ...
    country: "Italy",
    category: "Attractions",
    description: "Climb 463 steps for a panoramic view of Florence.",
    image: IMAGES.florence,
    rating: 4.7,
    reviewCount: 19870,
    estimatedCost: 20,
  ...
  },
  {
    ...
    category: "Attractions",
    description:
      "See Botticelli's Birth of Venus and Renaissance masterpieces.",
    image: IMAGES.florence,
    rating: 4.8,
    reviewCount: 12980,
    estimatedCost: 28,
  ...
  },
  {
    ...
    country: "Italy",
    category: "Experiences",
    description: "Glide through Venice's canals on a classic gondola.",
    image: IMAGES.venice,
    rating: 4.5,
    reviewCount: 11230,
    estimatedCost: 80,
  ...
  {
    id: "act-belem",
    name: "Belém Tower & Pastéis",
    city: "Lisbon",
    cityId: "loc-lisbon",
    country: "Portugal",
    category: "Attractions",
    description:
      "Visit the iconic tower, then grab the world's best custard tarts.",
    image: IMAGES.lisbon,
    rating: 4.6,
    reviewCount: 22000,
    estimatedCost: 15,
  ...
  },
  {
    ...
    city: "Barcelona",
    cityId: "loc-barcelona",
    country: "Spain",
    category: "Attractions",
    description: "Gaudí's unfinished masterpiece — a must-see basilica.",
    image: IMAGES.barcelona,
    rating: 4.9,
    reviewCount: 68000,
    estimatedCost: 26,
  ...
  {
    id: "act-sunset",
    name: "Oia Sunset Cruise",
    city: "Santorini",
    cityId: "loc-santorini",
    country: "Greece",
    category: "Experiences",
    description: "Sail along the caldera as the sun sets over the Aegean.",
    image: IMAGES.santorini,
    rating: 4.8,
    reviewCount: 9800,
    estimatedCost: 95,
...
let trips: Trip[] = [
  {
    ...
    name: "Italy Escape",
    description:
      "A week through Italy's most iconic cities — Rome, Florence and Venice.",
    ...
    items: [
      {
        id: "item-7",
        dayId: "day-3",
        activityId: "act-duomo",
        name: "Train Rome → Florence",
        category: "Transport",
        location: "Florence",
        startTime: "08:10",
        endTime: "09:40",
...
let expenses: Expense[] = [
  {
    ...
    tripId: "italy-escape",
    category: "Transport",
    description: "Train Rome → Florence",
    amount: 39,
    currency: "EUR",
    date: "2026-10-14",
    splitCount: 1,
...
export async function mockGetDashboard(): Promise<DashboardData> {
  ...
  return {
    ...
    stats: {
      ...
      totalRemainingBudget: upcoming.reduce(
...
export async function mockCreateTrip(input: {
  name: string;
  description?: string;
  startDate: string;
  endDate: string;
...
export async function mockUpdateTrip(
  tripId: string,
  input: Partial<Trip>,
): Promise<Trip> {
  await delay(400);
...
export async function mockAddStop(
  tripId: string,
  input: { locationId: string; arrivalDate: string; departureDate: string },
): Promise<TripStop> {
  await delay(500);
...
export async function mockDeleteStop(
  tripId: string,
  stopId: string,
): Promise<void> {
  await delay(300);
  const idx = tripStops.findIndex(
    (s) => s.id === stopId && s.tripId === tripId,
  );
...
// ── Itinerary Items ──
export async function mockAddActivity(
  dayId: string,
  input: {
    activityId: string;
    startTime: string;
  ...
  const item: ItineraryItem = {
    ...
    estimatedCost: input.estimatedCost ?? act?.estimatedCost ?? 0,
...
export async function mockDeleteActivity(
  dayId: string,
  itemId: string,
): Promise<void> {
  await delay(300);
...
export async function mockReorderActivities(
  dayId: string,
  orderedIds: string[],
): Promise<void> {
  await delay(300);
...
// ── Locations ──
export async function mockSearchLocations(filters?: {
  query?: string;
  country?: string;
  region?: string;
}): Promise<Location[]> {
...
// ── Activities ──
export async function mockSearchActivities(filters?: {
  query?: string;
  cityId?: string;
  category?: string;
  costMax?: number;
  ...
  if (filters?.cityId)
    result = result.filter((a) => a.cityId === filters.cityId);
  if (filters?.category)
    result = result.filter((a) => a.category === filters.category);
  if (filters?.costMax !== undefined)
    result = result.filter((a) => a.estimatedCost <= filters.costMax!);
  if (filters?.ratingMin !== undefined)
    result = result.filter((a) => a.rating >= filters.ratingMin!);
  return result;
}
...
export async function mockGenerateRecommendations(
  ...
  await delay(600);
  const opts: RecommendationFilters =
    typeof filters === "string" ? { tripId: filters } : filters;

  const trip = opts.tripId
    ? trips.find((t) => t.id === opts.tripId)
    : undefined;
  const targetCity =
    opts.city ||
    (opts.cityId
      ? locations.find((l) => l.id === opts.cityId)?.name
      : undefined) ||
    trip?.cities[0] ||
    "Rome";
  ...
  if (opts.category && opts.category !== "All") {
    relevantActivities = relevantActivities.filter(
      (a) => a.category.toLowerCase() === opts.category?.toLowerCase(),
    );
  }

  if (opts.budget !== undefined && opts.budget > 0) {
    relevantActivities = relevantActivities.filter(
      (a) => a.estimatedCost <= opts.budget!,
    );
  }

  if (opts.availableMinutes !== undefined && opts.availableMinutes > 0) {
    relevantActivities = relevantActivities.filter(
      (a) => a.durationMinutes <= opts.availableMinutes!,
    );
  }

  const limit = opts.limit ?? 6;

  return relevantActivities.slice(0, limit).map((a, idx) => {
    const matchScore = Math.max(
      0.65,
      Math.round((0.98 - idx * 0.05) * 100) / 100,
    );
    return {
      id: uid(),
      rank: idx + 1,
      ...
      score: matchScore,
      reason:
        opts.interests && opts.interests.length > 0
          ? `AI matched ${Math.round(matchScore * 100)}% for your ${opts.interests.slice(0, 2).join(" & ")} interests.`
          : idx === 0
            ? "Top AI match for your travel style and today's schedule."
            : idx === 1
              ? "Highly rated destination fitting your pace."
              : "Recommended spot nearby with high traveler ratings.",
      fitsBudget: opts.budget
        ? a.estimatedCost <= opts.budget
        : a.estimatedCost < 80,
      rating: a.rating,
      image: a.image,
    };
...
// ── Budget ──
export async function mockGetTripBudget(
  tripId: string,
  ...
  return {
    ...
    averagePerDay: Math.round(
      trip.estimatedSpend / Math.max(trip.daysCount, 1),
    ),
...
export async function mockAddExpense(
  tripId: string,
  input: {
    category: string;
    description: string;
...
export async function mockCopyTrip(token: string): Promise<Trip> {
  ...
  const newTrip: Trip = {
    ...
    status: "upcoming",
    activitiesCount: publicTrip.days.reduce(
