      ...
      promises.push(
        apiClient("/users/me/preferences", {
          ...
          body: JSON.stringify({
            ...
            ...(input.preferences && {
              cultureWeight: input.preferences.culture,
              foodWeight: input.preferences.food,
              adventureWeight: input.preferences.adventure,
              natureWeight: input.preferences.nature,
              relaxationWeight: input.preferences.relaxation,
              travelPace: input.preferences.travelPace,
